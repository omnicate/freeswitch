...
tests_unit_switch_event_CFLAGS = $(SWITCH_AM_CFLAGS) -I$(top_builddir)/libs/libtap/
tests_unit_switch_event_LDADD = $(FSLD) $(top_builddir)/libs/libtap/libtap.a
...
tests_unit_switch_hash_CFLAGS = $(SWITCH_AM_CFLAGS) -I$(top_builddir)/libs/libtap/
tests_unit_switch_hash_LDADD = $(FSLD) $(top_builddir)/libs/libtap/libtap.a
