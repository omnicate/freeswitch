...
int main()
{
  char local_ip[64] = {0}, *registrar = NULL, *tmp_buf = NULL, *callid_prefix = "autotest-invite-invalid-sdp-";
  ...
  /* FOR REFERENCE: Test call to invalid extension with valid SDP */
  ...
  /* Test call to invalid extension with invalid SDP missing c= */
  mbuf_rewind(sdp_mbuf);
  mbuf_printf(sdp_mbuf, "v=0\n");
  mbuf_printf(sdp_mbuf, "o=autotest 822 590 IN IP4 %s\n", local_ip);
  mbuf_printf(sdp_mbuf, "s=AutoTest\n");
  ...
  /* Test call to invalid extension with invalid SDP missing m= */
  mbuf_rewind(sdp_mbuf);
  mbuf_printf(sdp_mbuf, "v=0\n");
  mbuf_printf(sdp_mbuf, "o=autotest 822 590 IN IP4 %s\n", local_ip);
  mbuf_printf(sdp_mbuf, "s=AutoTest\n");
  ...
  /* Test call to invalid extension with invalid SDP with extra rtpmap in m= */
  mbuf_rewind(sdp_mbuf);
  mbuf_printf(sdp_mbuf, "v=0\n");
  mbuf_printf(sdp_mbuf, "o=autotest 822 590 IN IP4 %s\n", local_ip);
  mbuf_printf(sdp_mbuf, "s=AutoTest\n");
  ...
  mbuf_printf(sdp_mbuf, "t=0 0\n");
  mbuf_printf(sdp_mbuf, "a=sendrecv\n");
  mbuf_printf(sdp_mbuf, "m=audio 2268 RTP/AVP 0 127 555\n");
  mbuf_printf(sdp_mbuf, "a=rtpmap:0 PCMU/8000\n");
  mbuf_printf(sdp_mbuf, "a=rtpmap:127 telephone-event/8000\n");
  mbuf_printf(sdp_mbuf, "a=fmtp:127 0-11\n");
